// NOTE: Star Canvas Init. 
// Credit Chris(https://codepen.io/chrisyboy53/pen/oXZzQb) For the Concept.
$(document).ready(function () {
    ...
    console.log("-Stars Launched Successfully.");
});
...
function getColor() {
    return 'hsla(300,100%, ' + rnd(50,100) + '%, 1)';
} // first value. 300 purple stars. 
...
function draw() {
    ...
    ctx.fillStyle = 'rgba(3, 3, 3, 0.431)';
    ctx.fillRect(0,0, canvas.width, canvas.height);
