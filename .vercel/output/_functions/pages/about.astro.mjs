;!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="6531a9e9-672b-4b4e-a992-c03b86c12cb5",e._sentryDebugIdIdentifier="sentry-dbid-6531a9e9-672b-4b4e-a992-c03b86c12cb5")}catch(e){}}();import { $ as $$Container, a as $$Layout } from '../chunks/Layout_CjQuuQTj.mjs';
import { c as createAstro, a as createComponent, r as renderTemplate, m as maybeRenderHead, b as addAttribute, s as spreadAttributes, d as renderSlot, f as renderComponent } from '../chunks/astro/server_Bkp0-z4m.mjs';
import 'kleur/colors';
import { c as cn } from '../chunks/utils_DaMc5IgF.mjs';
import 'clsx';
import { a as HERO, S as SITE } from '../chunks/consts_Cz7b8feT.mjs';
...
}, "/home/source/GitHub/sourceaura.github.io/src/components/Link.astro", void 0);
...
}, "/home/source/GitHub/sourceaura.github.io/src/components/Connect.astro", void 0);

const myPhoto = new Proxy({"src":"/_astro/may-be.DFdu3FIy.png","width":1024,"height":1024,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/home/source/GitHub/sourceaura.github.io/src/assets/may-be.png";
							}
...
const $$About = createComponent(($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$About;
  const skills = ["JavaScript", "Python", "Go Lang", "TypeScript", "React", "Next.js", "Astro", "Tailwind CSS", "HTML", "CSS", "SQL", "PostgreSQL", "MongoDB", "Docker", "Kubernetes", "AWS", "Azure", "Git", "GitHub", "GitLab", "Bitbucket", "Linux", "Windows"];
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "About Me", "description": SITE.DESCRIPTION }, { "default": ($$result2) => renderTemplate`${renderComponent($$result2, "Container", $$Container, {}, { "default": ($$result3) => renderTemplate`${maybeRenderHead()}<div class="flex flex-col items-center justify-center min-h-screen py-12 px-4"><div class="w-full max-w-2xl mx-auto text-center">${renderComponent($$result3, "Image", $$Image, { "src": myPhoto, "alt": SITE.TITLE, "width": 192, "height": 192, "class": "rounded-full object-cover mx-auto mb-8" })}<div class="skills-ticker mb-8"><div class="skills-ticker-content">${skills.map((skill) => renderTemplate`<span class="skill-pill">${skill}</span>`)}</div></div>${renderComponent($$result3, "Connect", $$Connect, {})}</div></div>` })}` })}`;
}, "/home/source/GitHub/sourceaura.github.io/src/pages/about.astro", void 0);

const $$file = "/home/source/GitHub/sourceaura.github.io/src/pages/about.astro";
const $$url = "/about";
