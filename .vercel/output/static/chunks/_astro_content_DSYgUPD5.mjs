...
class DataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_Bn6sF24B.mjs');
...
function createGetCollection({
  ...
  return async function getCollection(collection, filter) {
    ...
    if (collection in contentCollectionToEntryMap) {
      ...
      const { default: imageAssetMap } = await import('./_astro_asset-imports_DixfAs6v.mjs');
      const result = [];
...
const contentEntryGlob = /* #__PURE__ */ Object.assign({"/src/content/petals/00-nemo/index.mdx": () => import('./index_DrO-y4uX.mjs'),"/src/content/petals/01-spot-eye-see/index.mdx": () => import('./index_CVKpHt4K.mjs'),"/src/content/petals/05-web-dev/index.mdx": () => import('./index_DuCRma-y.mjs'),"/src/content/petals/07-axols/index.mdx": () => import('./index_CseMtWeC.mjs'),"/src/content/petals/08-project-1/index.md": () => import('./index_D5Vhvto9.mjs'),"/src/content/petals/99-draft/index.md": () => import('./index_DHdF4_sx.mjs')});
...
const renderEntryGlob = /* #__PURE__ */ Object.assign({"/src/content/petals/00-nemo/index.mdx": () => import('./index_buTFAZBc.mjs'),"/src/content/petals/01-spot-eye-see/index.mdx": () => import('./index_CVVzYbXV.mjs'),"/src/content/petals/05-web-dev/index.mdx": () => import('./index_CZrCbrwm.mjs'),"/src/content/petals/07-axols/index.mdx": () => import('./index_DqeEku_W.mjs'),"/src/content/petals/08-project-1/index.md": () => import('./index_D20DbwKv.mjs'),"/src/content/petals/99-draft/index.md": () => import('./index_DOVSMhDp.mjs')});
