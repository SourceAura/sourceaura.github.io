  ...
  <footer class>
    <div class="max-w-7xl max-h-0 mx-auto px-4">
      <div class="pt-5 pb-12 md:flex md:items-center md:justify-between">
        ...
        <div>
          <!-- heart emoji ^_^  -->
          <p class="mt-8 text-sm content-center leading-6 text-white md:mt-0 md:order-1">
            made with {{ soulmeetsbody }} by
            <!-- Dev Preview -->
            <creator-preview
              :avatar="avi"
              :name="name"
        ...
        <!-- based on 
          <span class="creator-preview hover:text-royal text-white">
            <a
