...
<div class="max-w-7xl mx-auto border-gray-700 border-dashed border-l border-r">
  ...
  <div @click="scrollToTop" class="cursor-pointer fixed z-50 bottom-4 right-4 w-8 w-8 rounded-full bg-gray-900 text-white block text-indigo-600 hover:text-candyPink">
